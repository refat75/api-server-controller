...
type SharedInformerFactory interface {
	...
	Appscode() appscoderefatdev.Interface
}

func (f *sharedInformerFactory) Appscode() appscoderefatdev.Interface {
	return appscoderefatdev.New(f, f.namespace, f.tweakListOptions)
}
